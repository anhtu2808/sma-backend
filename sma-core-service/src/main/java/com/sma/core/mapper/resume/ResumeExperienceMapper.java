...
import com.sma.core.dto.message.embedding.resume.EmbeddingResumeExperience;
...
public interface ResumeExperienceMapper {
    ...
    EmbeddingResumeExperience toEmbeddingResumeExperience(ResumeExperience experience);
}
