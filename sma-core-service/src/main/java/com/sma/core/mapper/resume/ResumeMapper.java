...
public interface ResumeMapper {
    ...
    @Mapping(target = "parseAttemptId", ignore = true)
    @Mapping(target = "parseRequestedAt", ignore = true)
    @Mapping(target = "parseUpdatedAt", ignore = true)
    @Mapping(target = "parseErrorMessage", ignore = true)
