...
CREATE TYPE usage_event_status AS ENUM ('SUCCESS', 'FAIL');
...
CREATE TABLE resumes (
  ...
  parse_attempt_id varchar(100),
  parse_requested_at timestamp,
  parse_updated_at timestamp,
...
CREATE TABLE usage_events (
  ...
  feature_id int NOT NULL,
  amount int NOT NULL,
  status usage_event_status NOT NULL DEFAULT 'SUCCESS',
  created_at TIMESTAMP DEFAULT now()
);

CREATE TABLE usage_event_contexts (
  id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  usage_event_id int NOT NULL,
  event_source varchar(50) NOT NULL,
  source_id int NOT NULL,
  CONSTRAINT uk_usage_event_contexts_event_source_id UNIQUE (usage_event_id, event_source, source_id)
);
...
CREATE TABLE proposed_resumes (
    ...
    CONSTRAINT fk_proposed_resume_resume
        FOREIGN KEY (resume_id) REFERENCES resumes (id),

    CONSTRAINT fk_proposed_resume_job
...
ALTER TABLE usage_event_contexts ADD FOREIGN KEY (usage_event_id) REFERENCES usage_events (id) ON DELETE CASCADE;
